...
import { BsFillCloudArrowDownFill, BsFillCheckCircleFill, BsFillCursorFill, BsFillClipboard2HeartFill, BsFillExclamationTriangleFill, BsFillEggFill } from "react-icons/bs";

const ClickUpgradesList = ({ multiplierFunction, frontendArray, moneyFunction, balance, ...props }) => {
  ...
  return (
    <>
      <div className={styles.upgradeFlex}> hey </div>
    </>
  );
};
